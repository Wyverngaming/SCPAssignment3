...
<html lang="en">
  ...
  <body class="container">
    <h1>use the form below to create a new record</h1>
 <form class="form-group" method="post" action="connection.php"
 <label>SCP Item:</label>
 <br>
 <input type="text" class="form-control" name="item" placeholder="...enter SCP Item number: here" required>
 <br>
 ...
 <br>
 <input type="submit" class="btn btn-primary" name="create" value="submit new SCP record">
